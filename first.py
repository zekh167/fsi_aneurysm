...
with open('hollowcylinder16.1.face','r') as facefile:
    ...
    for lineNum,line in enumerate(target):
	    ...
	    # Read the outlet nodes of fluid and solid
	    elif regionMarker == -2:
		outletFaceNodes=[0]*3
...
#print ('solidInletNodes'),solidInletNodes
#print len(solidInletNodes)
#print ('fluidInletNodes'),fluidInletNodes
#print len(fluidInletNodes)
#print ('interfaceOutletNodes'),interfaceOutletNodes
#print len(interfaceOutletNodes)	        
#print ('fluidOutletNodes'),fluidOutletNodes
#print len(fluidOutletNodes)
...
# Set no velocity in the z-direction for all fluid nodes 
for nodeIdx in range(0, len(fluidNodesList)):
    nodeNumber = fluidNodesList[nodeIdx]
...
# Set no displacement in the z-direction for all solid nodes
for nodeIdx in range(0, len(solidNodesList)):
    nodeNumber = solidNodesList[nodeIdx]
    #nodeDomain = fluidDecomposition.NodeDomainGet(nodeNumber, 1)
    #if (nodeDomain == computationalNodeNumber):
