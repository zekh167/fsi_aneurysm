...
with open('vessel.1.ele','r') as elefile:
...
with open('vessel.1.face', 'r') as facefile:
...
with open("vessel.1.node","r") as nodefile:
...
for nodeIdx in range(0, numberOfFluidNodes):
    ...
    if (debug):
            ...
            print('         Position         = [ %.4f, %.4f, %.4f ]' % (xPosition, yPosition, zPosition))
...
nodeNumber = solidInletNodesOnTopYaxis[1]
...
nodeNumber = solidInletNodesOnLeftXaxis[1]
#nodeDomain = computationalNodeNumber
#if (nodeDomain == computationalNodeNumber):
fsiBoundaryConditions.SetNode(interfaceLagrangeField, iron.FieldVariableTypes.U, 1, \
                                  iron.GlobalDerivativeConstants.NO_GLOBAL_DERIV, \
...
nodeNumber = solidInletNodesOnBottomYaxis[1]
#nodeDomain = computationalNodeNumber
#if (nodeDomain == computationalNodeNumber):
fsiBoundaryConditions.SetNode(interfaceLagrangeField, iron.FieldVariableTypes.U, 1, \
                                  iron.GlobalDerivativeConstants.NO_GLOBAL_DERIV, \
...
nodeNumber = solidInletNodesOnRightXaxis[1]
#nodeDomain = computationalNodeNumber
#if (nodeDomain == computationalNodeNumber):
fsiBoundaryConditions.SetNode(interfaceLagrangeField, iron.FieldVariableTypes.U, 1, \
                                  iron.GlobalDerivativeConstants.NO_GLOBAL_DERIV, \
